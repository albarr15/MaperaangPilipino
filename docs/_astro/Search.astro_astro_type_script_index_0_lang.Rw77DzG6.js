const y = (function () {
    ...
    return r && r.supports && r.supports("modulepreload")
      ? "modulepreload"
      : "preload";
  })(),
  w = function (m) {
...
class v extends HTMLElement {
  constructor() {
    ...
    const r = this.querySelector("button[data-open-modal]"),
      c = this.querySelector("button[data-close-modal]"),
      d = this.querySelector("dialog"),
      p = this.querySelector(".dialog-frame"),
      u = (e) => {
        ("href" in (e.target || {}) ||
          (document.body.contains(e.target) && !p.contains(e.target))) &&
          t();
      },
      o = (e) => {
        (d.showModal(),
    ...
    (r.addEventListener("click", o),
      ...
      window.addEventListener("keydown", (e) => {
        (e.metaKey === !0 || e.ctrlKey === !0) &&
          e.key === "k" &&
          (d.open ? t() : o(), e.preventDefault());
      }));
    let f = {};
    try {
      f = JSON.parse(this.dataset.translations || "{}");
    } catch {}
    const s =
    ...
    window.addEventListener("DOMContentLoaded", () => {
      (window.requestIdleCallback || ((l) => setTimeout(l, 1)))(async () => {
        const { PagefindUI: l } = await S(async () => {
          const { PagefindUI: a } = await import("./ui-core.D2oRCWSx.js");
          return { PagefindUI: a };
        }, []);
        new l({
          ...E,
